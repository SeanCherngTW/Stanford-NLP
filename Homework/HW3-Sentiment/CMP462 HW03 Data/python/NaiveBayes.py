...
class NaiveBayes:
    ...
    def classify(self, words):
        ...
        """
        score_pos, score_neg = self.imdbData.get_score(words)
    ...
    def addExample(self, klass, words):
        ...
        * Returns nothing
        """
        self.imdbData.add_words(klass, self.filterStopWords(words))
    ...
    def filterStopWords(self, words):
        ...
        * Filters stop words found in self.stopList.
        """
        return [word for word in words if word not in self.stopList]
